        ...
        <div className="min-h-screen bg-pure-white flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <p className="mt-2 text-center text-sm text-gray-600">
                    Or{' '}
                    <Link href="/signup" className="font-medium text-primary-green hover:text-green-700">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <div className="flex items-center justify-end mt-2">
                                <Link href="/forgot-password" className="text-sm font-medium text-primary-green hover:text-green-700">
