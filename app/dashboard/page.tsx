  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const errorData = await response.json();
        const errorMsg = errorData.error || 'Failed to generate letter';
        setError(errorMsg);
        alert('❌ Generation failed: ' + errorMsg);
      }
    } catch (error) {
  ...
  const generateFollowUp = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/generate-followup', {
        ...
        body: JSON.stringify({
          userName: latestLetter.user?.name || 'Demo User',
      ...
      alert('❌ Network error generating follow-up letter.');
    } finally {
      setIsGenerating(false);
    }
  };
  ...
  return (
    <div className="py-8 bg-pure-white min-h-screen">
      ...
      <div className="space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-6 border-t border-border-gray">
              <button 
                ...
                className={`px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 tracking-tight ${
          ...
          <div className="bg-pure-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300 md:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                <h3 className="font-bold text-primary-black mb-3 tracking-tight">Credit Dispute</h3>
                <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                  Step-by-step guidance for disputing inaccurate credit report items
                </p>
                <button 
                  onClick={() => setSelectedWorkflow('creditdispute')}
              ...
              {/* Follow-up Letter Workflow */}
              <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                <h3 className="font-bold text-primary-black mb-3 tracking-tight">Follow-up Letter</h3>
                <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                  Generate follow-up letters for pending disputes
                </p>
                <button 
                  onClick={() => setSelectedWorkflow('followupletter')}
                  className="w-full bg-primary-green hover:bg-green-700 text-white px-4 py-2 rounded-lg font-medium transition-colors tracking-tight"
                >
                  Start Workflow
                </button>
              ...
              {/* Metro 2 Education */}
              <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                <h3 className="font-bold text-primary-black mb-3 tracking-tight">Metro 2 Education</h3>
                <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                  Learn about Metro 2 credit reporting standards
                </p>
                <button 
                  onClick={() => setSelectedWorkflow('metro2education')}
                  className="w-full bg-primary-green hover:bg-green-700 text-white px-4 py-2 rounded-lg font-medium transition-colors tracking-tight"
                >
                  Start Workflow
                </button>
              ...
              {/* AI Chat Guidance */}
              <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                <h3 className="font-bold text-primary-black mb-3 tracking-tight">AI Chat Guidance</h3>
                <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                  Get AI-powered guidance for credit questions
                </p>
                <button 
                  onClick={() => setSelectedWorkflow('aichatguidance')}
                  className="w-full bg-primary-green hover:bg-green-700 text-white px-4 py-2 rounded-lg font-medium transition-colors tracking-tight"
                >
                  Start Workflow
                </button>
              ...
              {/* Credit Education */}
              <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                <h3 className="font-bold text-primary-black mb-3 tracking-tight">Credit Education</h3>
                <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                  Comprehensive credit education resources
                </p>
                <button 
                  onClick={() => setSelectedWorkflow('crediteducation')}
                  className="w-full bg-primary-green hover:bg-green-700 text-white px-4 py-2 rounded-lg font-medium transition-colors tracking-tight"
                >
                  Start Workflow
                </button>
        ...
        <div className="flex items-center my-12">
          <div className="flex-1 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent"></div>
          <div className="px-4 text-gray-500 text-sm font-medium">Educational Modules</div>
          <div className="flex-1 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent"></div>
        </div>
        ...
        <div className="bg-pure-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300">
          <div className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              Learn about Metro 2 credit reporting standards (educational purposes only)
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              <h3 className="font-bold text-primary-black mb-3 tracking-tight">Account Status</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
                Educational example: Account status codes may be inconsistent if reporting doesn't follow Metro 2 standards.
              </p>
            </div>
            
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              <h3 className="font-bold text-primary-black mb-3 tracking-tight">Balance vs Past Due</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
                Educational example: If balance and past due amounts are inaccurate or incomplete, this may indicate reporting issues.
              </p>
            </div>
            
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              <h3 className="font-bold text-primary-black mb-3 tracking-tight">Payment History / Rating</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
                Educational example: Payment ratings may be inconsistent if not properly documented according to Metro 2 guidelines.
              </p>
            </div>
            
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              <h3 className="font-bold text-primary-black mb-3 tracking-tight">Important Dates</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
                Educational example: Date opened, first delinquency, and last reported dates may be inaccurate or incomplete if not properly maintained.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6 p-6 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-yellow-800 font-medium leading-relaxed">
              Educational information only. No deletion strategies or guaranteed removal methods provided. Please review your own credit report and documentation.
            </p>
          </div>
        </div>
        ...
        <div className="bg-pure-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            {resources.map((resource) => (
              <div key={resource.id} className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                <h3 className="font-bold text-primary-black mb-3 tracking-tight">{resource.title}</h3>
                <p className="text-gray-600 text-sm mb-3 leading-relaxed">
                  {resource.title} - Educational resource
                </p>
                <a href={resource.url} target="_blank" rel="noopener noreferrer" className="text-primary-green hover:text-green-700 text-sm font-medium">
                  Visit Resource →
                </a>
              </div>
            ))}
            ...
            {/* Default Resources */}
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              <h3 className="font-bold text-primary-black mb-3 tracking-tight">CFPB Resources</h3>
              <p className="text-gray-600 text-sm mb-3 leading-relaxed">
                Consumer Financial Protection Bureau credit guides and tools
              </p>
              <a href="https://www.consumerfinance.gov/consumer-tools/credit-reports-and-scores/" target="_blank" rel="noopener noreferrer" className="text-primary-green hover:text-green-700 text-sm font-medium">
                Visit CFPB →
              </a>
            </div>
            
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              <h3 className="font-bold text-primary-black mb-3 tracking-tight">Annual Credit Report</h3>
              <p className="text-gray-600 text-sm mb-3 leading-relaxed">
                Get your free annual credit reports from all three bureaus
              </p>
              <a href="https://www.annualcreditreport.com/" target="_blank" rel="noopener noreferrer" className="text-primary-green hover:text-green-700 text-sm font-medium">
                Get Reports →
              </a>
            </div>
            
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              <h3 className="font-bold text-primary-black mb-3 tracking-tight">FTC Identity Theft</h3>
              <p className="text-gray-600 text-sm mb-3 leading-relaxed">
                Federal Trade Commission identity theft resources
              </p>
              <a href="https://www.identitytheft.gov/" target="_blank" rel="noopener noreferrer" className="text-primary-green hover:text-green-700 text-sm font-medium">
                Visit FTC →
              </a>
            </div>
            
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              <h3 className="font-bold text-primary-black mb-3 tracking-tight">Experian</h3>
              <p className="text-gray-600 text-sm mb-3 leading-relaxed">
                Access your Experian credit report and score
              </p>
              <a href="https://www.experian.com/" target="_blank" rel="noopener noreferrer" className="text-primary-green hover:text-green-700 text-sm font-medium">
                Visit Experian →
              </a>
            </div>
            
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              <h3 className="font-bold text-primary-black mb-3 tracking-tight">Equifax</h3>
              <p className="text-gray-600 text-sm mb-3 leading-relaxed">
                Access your Equifax credit report and score
              </p>
              <a href="https://www.equifax.com/" target="_blank" rel="noopener noreferrer" className="text-primary-green hover:text-green-700 text-sm font-medium">
                Visit Equifax →
              </a>
            </div>
            
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              <h3 className="font-bold text-primary-black mb-3 tracking-tight">TransUnion</h3>
              <p className="text-gray-600 text-sm mb-3 leading-relaxed">
                Access your TransUnion credit report and score
              </p>
              <a href="https://www.transunion.com/" target="_blank" rel="noopener noreferrer" className="text-primary-green hover:text-green-700 text-sm font-medium">
                Visit TransUnion →
              </a>
            </div>
            
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              <h3 className="font-bold text-primary-black mb-3 tracking-tight">FTC Credit Reporting</h3>
              <p className="text-gray-600 text-sm mb-3 leading-relaxed">
                Federal Trade Commission credit reporting information
              </p>
              <a href="https://www.consumer.ftc.gov/articles/0155-free-credit-reports" target="_blank" rel="noopener noreferrer" className="text-primary-green hover:text-green-700 text-sm font-medium">
                Visit FTC →
              </a>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              ...
              <p className="text-xs text-gray-500 italic">
                Upload documents in the admin panel to reference them when generating letters
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="p-4 sm:p-6 border-b border-border-gray">
              <div className="flex justify-between items-center">
                <h3 className="text-lg sm:text-2xl font-bold text-primary-black truncate mr-4">
                  {getLetterTemplate(selectedLetter)?.title}
                </h3>
                <button 
                  onClick={() => {
              ...
              <div className="bg-light-gray p-4 sm:p-6 rounded-lg border border-gray-200">
                {selectedLetter === 'generated' && isEditing ? (
                  ...
                  <pre className="text-primary-black whitespace-pre-wrap font-sans text-xs sm:text-sm" style={{lineHeight: '1.7'}}>
                    {selectedLetter === 'generated' ? editedLetter : getLetterTemplate(selectedLetter)?.content}
                  </pre>
                )}
              </div>
            </div>
            <div className="p-4 sm:p-6 border-t border-border-gray bg-light-gray">
              <div className="flex flex-col space-y-4">
                <div className="flex flex-wrap gap-2 sm:gap-3">
                  ...
                  <button 
                    onClick={() => navigator.clipboard.writeText(selectedLetter === 'generated' ? editedLetter : getLetterTemplate(selectedLetter)?.content || '')}
                  ...
                  <button 
                    onClick={() => {
                      const content = selectedLetter === 'generated' ? editedLetter : getLetterTemplate(selectedLetter)?.content || '';
      ...
      {selectedWorkflow && getWorkflowContent(selectedWorkflow, workflows) && (
        <div 
          className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-2 sm:p-4 z-50"
              ...
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-lg sm:text-2xl font-bold text-primary-black">
                    {getWorkflowContent(selectedWorkflow, workflows)?.title}
                  </h3>
                  <p className="text-gray-600 text-sm mt-2">
                    {getWorkflowContent(selectedWorkflow, workflows)?.description}
                  </p>
                </div>
                <button 
